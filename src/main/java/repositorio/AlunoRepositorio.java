...
public class AlunoRepositorio {
	...
	public ArrayList<Aluno> autenticarAluno(String email, String senha) {
		return (ArrayList<Aluno>) entityManager
				.createQuery("from Aluno where email = :email and senha = :senha").setParameter("email", email)
				.setParameter("senha", senha).getResultList();
	}

	public Aluno adicionar (String nome,String senha, String email, String cpf, Turno turno) {
